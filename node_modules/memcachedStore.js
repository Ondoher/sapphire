...
var mcServer = CONFIG.memcacheServer?CONFIG.memcacheServer:'localhost:11211';
var mcOptions = CONFIG.memcachOptions?CONFIG.memcachOptions:{};
...
var Session = new Class(
{
	...
	update : function(session)
	{
		...
		memcached.set(this.sessionId, JSON.stringify(this.session), duration, function() {});
	},
