...
*/
	initialize : function(ns, req)
	{
		...
		this.processing = 0;
		this.processFile(CONFIG.basePath + 'master.html', this.readFile.bind(this, function(content)
		{
...
//		mangleList = mangleList.concat(this.urls);
		...
		this.waitOnProcessing(function ()
		{
			...
			this.mangle()
				.then(function()
				{
					...
					masterJS += '		var ' + ns + '= {};\n';
					masterJS += '		var SAPPHIRE = {};\n';
					masterJS += '		SAPPHIRE.ns = ' + JSON.stringify(ns) + ';\n';
					masterJS += '		SAPPHIRE.forceMethod = ' + JSON.stringify(CONFIG.qsToBody?'GET':false) + ';\n';
