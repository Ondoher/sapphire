...
*/
	initialize : function(ns, req)
	{
		...
		this.masterFile = rootDir + '/master.html';
...
*/
	...
	// The dialogs
		...
		return this.mangler.mangleUrls(mangleList)
			...
			// The dialogs
				...
				if (!shorty)
					this.mangleThese(this.javascriptFiles);
	...
	{
		var deferred = Q.defer();
		var filename = paths.urlPathToFilePath(file, relative);
