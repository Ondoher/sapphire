...
module.exports = function()
{
	return function(req, res, next)
	{
		...
		var featuresIndex = paths.indexOf('features');
		var pagesIndex = paths.indexOf('pages');
		var dialogsIndex = paths.indexOf('dialogs');
		var panelsIndex = paths.indexOf('panels');
		...
		if (serviceIndex != -1)
			...
			paths = paths.slice(0, featuresIndex);
		else if (pagesIndex != -1)
			paths = paths.slice(0, pagesIndex);
		else if (dialogsIndex != -1)
			paths = paths.slice(0, dialogsIndex);
		else if (panelsIndex != -1)
			paths = paths.slice(0, panelsIndex);
